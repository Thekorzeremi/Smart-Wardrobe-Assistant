...
function prepareAIPayload(weather, userId, filters = {}) {
    let request = "Propose-moi la meilleure tenue pour aujourd'hui. Donne-moi une recommandation de tenue complète (haut, bas, chaussures, accessoires) adaptée à la météo actuelle et à mon style personnel.";
  if (filters.occasion) {
  ...
  request += " Justifie ta recommandation en expliquant pourquoi cette tenue est appropriée pour les conditions météorologiques et comment elle correspond à mon style.";
  return {
    weather: {
